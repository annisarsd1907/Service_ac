                      ...
                      <label for="level" class="col-sm-2 col-form-label">Level</label>
                       ...
                       <!--  <input type="text" class="form-control" id="level" name="level"> -->
                        <select name="level" class="form-control">
                            <option value="admin" echo "selected='selected'">Admin</option>
                            <option value="operator" echo "selected='selected'">Operator</option>
                            <option value="member" echo "selected='selected'">Member</option>
                        </select>
                        </div>
                    </div>
