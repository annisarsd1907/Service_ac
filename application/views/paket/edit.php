  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Promo Paket</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
               ...
               <input type="hidden" name="id" value="<?php echo $paket->id; ?>">
                    <div class="form-group row">
                      <label for="jenis" class="col-sm-2 col-form-label">Nama Paket</label>
                        <div class="col-sm-6">
                        <input value="<?php echo $paket->jenis; ?>" type="text" class="form-control" id="jenis" name="jenis">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="harga" class="col-sm-2 col-form-label">Harga</label>
                        <div class="col-sm-6">
                        <input value="<?php echo $paket->harga; ?>" type="text" class="form-control" id="harga" name="harga">
                        </div>
                    </div>
