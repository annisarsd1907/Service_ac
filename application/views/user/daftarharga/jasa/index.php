      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <h2 class="section-heading animated" data-animation="bounceInUp">Jasa</h2>
            <p>Jasa yang tersedia, dengan pilihan Harga yang terjangkau</p>
          </div>
        </div>
      </div>
