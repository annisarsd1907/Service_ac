      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <h2 class="section-heading animated" data-animation="bounceInUp">Sparepart</h2>
            <p>Sparepart yang tersedia, dengan pilihan Harga yang terjangkau</p>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="table-responsive">          
              <table class="table-harga">
                  <thead>
                    <tr>
                      <th width="150px">Jenis Sparepart</th>
