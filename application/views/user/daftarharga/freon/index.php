      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <h2 class="section-heading animated" data-animation="bounceInUp">Freon</h2>
            <p>Freon yang tersedia, dengan pilihan Harga yang terjangkau</p>
          </div>
        </div>
      </div>
