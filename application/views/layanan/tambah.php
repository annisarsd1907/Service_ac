       ...
       <div class="row">
           <div class="col-md-12">
              <div class="py-4">
               ...
               <form action="<?php echo site_url('Layanan/simpan');?>" method="post">
                    ...
                    <div class="form-group row">
                      <label for="tanggal_service" class="col-sm-2 col-form-label">Tanggal Service</label>
                        <div class="col-sm-6">
                        <input type="text" class="form-control" id="tanggal_service" name="tanggal_service">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="jam_service" class="col-sm-2 col-form-label">Jam Service</label>
                        <div class="col-sm-6">
                        <input type="text" class="form-control" id="jam_service" name="jam_service">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="jumlah_unit" class="col-sm-2 col-form-label">Jumlah Unit</label>
                        <div class="col-sm-6">
                        <input type="text" class="form-control" id="jumlah_unit" name="jumlah_unit">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="merk_ac" class="col-sm-2 col-form-label">Merk AC</label>
                        <div class="col-sm-6">
                        <input type="text" class="form-control" id="merk_ac" name="merk_ac">
                        </div>
                    </div>
